...
class SampleGenerator:
	...
	def get_infoID_train_and_test_array_dict(self):
		...
		for infoID in self.infoIDs:
			...
			if self.AGG_TIME_SERIES == True:
				y_train = agg_y_array_v2_mult_output_fts(y_train)
			...
			if self.AGG_TIME_SERIES == True:
				y_val = agg_y_array_v2_mult_output_fts(y_val)
			else:
			...
			if self.AGG_TIME_SERIES == True:
				y_val_sliding_window = agg_y_array_v2_mult_output_fts(y_val_sliding_window)
			else:
			...
			if self.AGG_TIME_SERIES == True:
				y_test = agg_y_array_v2_mult_output_fts(y_test)
			else:
			...
			if self.AGG_TIME_SERIES == True:
				y_test_sliding_window = agg_y_array_v2_mult_output_fts(y_test_sliding_window)
			else:
	...
	def get_infoID_train_and_test_array_dict_v2_fixed_dates(self):
		...
		for infoID in self.infoIDs:
			...
			if self.AGG_TIME_SERIES == True:
				y_sliding_window = agg_y_array_v2_mult_output_fts(y_sliding_window)
			...
			if self.AGG_TIME_SERIES == True:
				y_nonsliding_window = agg_y_array_v2_mult_output_fts(y_nonsliding_window)
			else:
